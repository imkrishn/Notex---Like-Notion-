  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col my-4 select-none ">
        ...
        <div className={` ${menu === 'Search' && 'bg-[#8ECAE9]'} w-full flex items-center  gap-3 rounded-sm px-3 py-0.5 cursor-pointer hover:bg-[#8ECAE9] hover:text-[#786B6B] active:bg-[#63A1C0]`}>
